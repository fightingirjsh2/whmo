---
title: The Case for a Tiny Destiny 3, Crafted by a Smaller Bungie
description: Smaller Bungie, Smaller Budget, Smaller Launch, Bigger Journey
date: 2026-06-17
author: C.M.
tags:
  - Destiny
...
That's not just me saying that, in the weeks since Bungie announced the end of active development of Destiny 2, players and jounralists have been weighing in on the future of the franchise if there is one at all. Jason Shreier and Paul Tassi have both reported that one of the major hangups causing Sony to not have greenlit Destiny 3 by now is the massive cost associated with developing the project. The numbers being thrown around are daunting but not surprising, 5-6 years and around $500 million dollars, if not more. This shouldnt come as a surprise if youve been watching the games industry recently, games are coming in with massive budgets and take an eternity to develop. Jason Schreier has made two videos discussing these topics and they are worth a watch to understand some of the backstory, but I think for now it needs to be taken a fact.

With this in mind its understandable why Sony hasn't agreed to fund a Destiny 3. After Marathon's questionable success and Destiny 2 slowly but surely losing players over the years, especially after 2024's The Final Shape expansions, it seems dubious at best to put that type of money into a studio that struggled to ship Marathon on time and presumably on budget (reportedly Marathon cost over $200 million dollars). 

After the decision to leave behind Destiny 2 to give Marathon a fair shake at success, Bungie is currently pitching new projects to work on for the future. A round of layoffs is about to hit the studio like a freight train, reportedly upwards of 50% of the studio, leaving behind a solid 400 person development team that is going to give Marathon its full focus for the next year or so. Who knows, maybe a coming update with take Marathon to the moon, but assuming it continues at its current trajectory, its safe to assume that sometime in 2027 Bungie will assume development on a new project and leave behind a smaller team on Marathon to continue delivering small content updates at a steady pace.

But assuming Bungie is only approximately 400 developers, and 100 stay on Marathon, is it realistic to deliver a full blown Destiny 3? No probably not, but that is why we don't need a large Destiny 3, we need a tiny one.

Destiny 1 and Destiny 2 each launched with 4 destinations surrounded by systems of questionable quality; Destiny 3 can and should be smaller and more focused. Over the years players have demanded the game return to deeper mysterious worlds full of surprises, and you do not need 4 destinations to deliver that. When I look back at my time with Destiny and Destiny 2, I am nostalgic for the music, the worlds, the raids, and the memories made with friends. You do not need 4 destinations for that. 

Development budget, man power requirements, and time are incredibly important considerations both for getting a Destiny 3 greenlit in the first place and then getting it across the finish line. Focusing on a smaller offering that could be achieved with a smaller team on a tighter timeline and budget is essential for getting the game into players hands. This is especially important with the rumors circulating about the size of the layoffs Bungie is about to endure. A limited scope Destiny 3 may be our only hope.
...
While some may be disappointed with one destination, the nature of destiny makes this a self healing problem. With each expansion, the world grows and this dillema is resolved.
...
For example, in another article I talk about the issues subclass 3.0 brought to the game, maybe this could be a good time to refactor the system, while keeping the core abilities an animations that are so time consuming to create. Leverage the weapons and armor systems that are already loved but retune them to fix the mistakes of the past without having to redesign the entire concept of weapons and armor. For some this will be a boring solution, but for many that wanted Destiny 2 to continue it will be a perfect way to bring the game into a new generation without losing the soul of Destiny 2. For many players, this Destiny 3 would be an opportunity to return after years away from the game, and will feel fresh with just a fresh coat of polish on these existing systems.
